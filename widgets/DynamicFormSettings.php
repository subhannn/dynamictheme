<?php namespace Kincir\Dynamictheme\Widgets;
 ...
 */
class DynamicFormSettings extends WidgetBase
{
    ...
    protected function makeFormField($name, $config = [])
    {
        ...
        $field->arrayName = isset($config['arrName'])?$config['arrName']:$this->arrayName;
